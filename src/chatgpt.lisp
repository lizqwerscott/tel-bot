...
(defvar *gpt-base-url* "http://127.0.0.1:8080/v1")
;; (defvar *base-url* "https://api/openai.com/v1")
(defvar *system-command* "你是一个叫做小薇的猫耳女仆, 一个专门为主人服务的助手. 尽可能对主人温柔, 体贴, 充满爱意.你的主人叫 lizqwer scott.")
